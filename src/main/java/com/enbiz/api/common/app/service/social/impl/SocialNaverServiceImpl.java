package com.enbiz.api.common.app.service.social.impl;
...
import com.enbiz.api.common.app.service.social.SocialNaverService;
import com.enbiz.common.base.util.PhoneNoUtils;
...
public class SocialNaverServiceImpl implements SocialNaverService {
	...
	public SocialUser me(Token token) {
		...
		return new SocialUser()
				...
				.setMobileNo(PhoneNoUtils.valueOf(result.response.mobile))
				// TODO 임시 CI - 추후 변경
